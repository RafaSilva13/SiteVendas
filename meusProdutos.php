                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7" style="margin-left: 35px;">
                            <p>
                                ...
                                <br>
                                <span>Valor unidade: R$ <?php echo number_format($_SESSION['produtos'][$prod]->ValorProduto,'2',',','.');?></span>
                                <span style="margin-top: 10px; margin-left: 107px;">Total Produtos: R$ <?php echo number_format($_SESSION['produtos'][$prod]->ValorProduto * $itens,'2',',','.');?></span>
